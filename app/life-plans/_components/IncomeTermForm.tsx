...
interface Props {
  ...
  defaultValues?: IncomeTerm;
}

export default function IncomeTermForm({ action, defaultValues }: Props) {
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="1 回の支給あたりの値を入力"
          min="0"
          max="12"
          step="0.5"
          required
          disabled={isPending}
          className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-400 placeholder:text-sm focus:border-primary focus:ring-2 focus:ring-primary disabled:opacity-50"
        />
      </div>
